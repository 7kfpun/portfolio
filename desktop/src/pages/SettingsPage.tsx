  ...
  return (
    <Container>
      <Header>
        ...
        <Description>Manage your application preferences and API keys</Description>
      </Header>
      ...
      <Card>
        ...
        <Section>
          ...
          <SectionDescription>
            ...
            Massive API may be used in future versions or with paid API plans.
          </SectionDescription>

          <InfoBox>
            Note: Polygon.io free tier only supports US stocks. Japan (JPX) and Taiwan (TWSE) stocks currently require manual price updates in prices.csv.
            Learn more at{' '}
            <a
